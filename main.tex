...
From the observer's perspective, three types of situations can happen when the agent tries an interaction with a mobile entity:
\begin{enumerate}
...
\end{enumerate}
From the agent's perspective, situations of types 1 and 2 can occur in the same context $E$, and situations of type 2 and 3 cannot be distinguished as they yield the same result.
