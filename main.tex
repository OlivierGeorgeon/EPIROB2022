...
The agent adjusts $S_i$ each time $i$ succeeds or fails to improve the estimation. %Previous implementations of signatures used formal neurons [ ] or discrete ensembles of interactions [ ].
