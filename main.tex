...
1) learning to define, recognize and localize entities that have free movements (e.g. other agents), starting with uninterpreted sensory stimuli and no notion of space,
