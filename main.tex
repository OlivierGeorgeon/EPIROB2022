...
\subsection{Separating certainty and probability}\label{separate}
...
\end{enumerate}
From the agent's perspective, situations 2 and~3 cannot be distinguished, as they have the same result, and situations~2 prevents the construction of the signature.
